...
const SuccessAuthentication = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0B2A52] text-white">
      ...
      <p className="text-sm text-gray-300 mb-6">Your password has been changed successfully.</p>
      <button className="bg-[#B31942] py-2 px-6 rounded-md text-white font-semibold hover:opacity-90" onClick={() => navigate("/login")}>
        Back to Login
      </button>
    </div>
  );
